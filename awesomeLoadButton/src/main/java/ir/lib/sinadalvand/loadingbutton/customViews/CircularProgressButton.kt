...
import ir.lib.sinadalvand.loadingbutton.disposeAnimator
import ir.lib.sinadalvand.loadingbutton.presentation.ProgressButtonPresenter
    ...
    private val morphRevertAnimator by lazy {
        AnimatorSet().apply {
            playTogether(
                    ...
                    widthAnimator(this@CircularProgressButton, finalWidth, initialState.initialWidth ?: 0),
...
//        saveInitialState()
    ...
    fun setTextApply(txt: String) {
        setText(txt)
        initialState.initialText = txt
    }
